...
class Game:
    ...
    def setup(self):
        ...
        forest.exits = {"N": cave, "E": None, "S": castle, "O": None}  # Passage interdit vers la tour
        tower.exits = {"N": cottage, "E": None, "S": swamp, "O": None}  # Suppression de la connexion vers la forêt
        cave.exits = {"N" : None, "E" : cottage, "S" : forest, "O" : None}
        cottage.exits = {"N" : None, "E" : None, "S" : tower, "O" : cave}
        swamp.exits = {"N": tower, "E": None, "S": None, "O": castle}  # Ajout d'une sortie vers la tour
    ...
    def process_command(self, command_string) -> None:
        ...
        # Si la commande est vide, ne rien afficher
